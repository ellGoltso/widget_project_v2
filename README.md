...
Функция csv_reader() принимает путь к csv файлу и возвращает список словарей с данными из него

Функция excel_reader() ринимает путь к xlsx файлу и возвращает список словарей с данными из него
